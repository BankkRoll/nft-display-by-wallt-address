    ...
    return (
      <div>
        ...
        <input 
            ...
            <label 
                for="wallet"
                className="top-1 text-gray-600 cursor-text peer-focus:text-xs peer-focus:-top-4 peer-focus:text-purple-600 transition-all">Wallet Address
            </label>
        <label 
            for="collection"
            className="my-4 left-0 text-gray-600 cursor-text peer-focus:text-xs peer-focus:-top-4 peer-focus:text-purple-600 transition-all">NO ENS
        </label>
        
        
        <button 
          className={"disabled:bg-slate-50 text-white bg-blue-400 px-3 mt-3 rounded-md w-1/6 my-5"} 
          onClick={ () => {
